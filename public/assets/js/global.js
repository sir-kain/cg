...
$(function () {
    ...
    /* 01 - VARIABLES */
    /*================*/
    var swipers = [], winW, winH, winScr, _isresponsive, xsPoint = 480, smPoint = 768, mdPoint = 992, lgPoint = 1200,
        addPoint = 1600,
    ...
    $('.js-contact-form').submit(function (e) {
        ...
        // $(form).find('[name="fields[email]"]').remove();
    ...
    /*Raccourcis menu pour les presentations*/
    $(this).find(".presentation-icon").show();
    $(this).find(".presentation-icon-hover").hide();
    $("h6").hover(
        function () {
            // $( this ).append( $( "<span> ***</span>" ) );
            $(this).find(".presentation-icon").hide();
            $(this).find(".presentation-icon-hover").show();
            if (!$(this).hasClass('active')) {
                $(this).addClass('bo-r-h');
            }
        }, function () {
            $(this).find(".presentation-icon").show();
            $(this).find(".presentation-icon-hover").hide();
            if (!$(this).hasClass('active')) {
                $(this).removeClass('bo-r-h');
            }
