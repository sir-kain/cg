<div style="padding-bottom: 0px;"  class="main-block style-2 clearfix container">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                <div class="block-header">
                    ...
                    <div class="block-text">Le genre est un concept sociologique qui permet de comprendre les rapports sociaux entre les hommes-femmes dans la société.</div>
                </div>
            </div>
        </div>
